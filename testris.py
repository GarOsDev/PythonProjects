...
def tetris():
    ...
    while(True):
        ...
        if event.name == "esc":
            ...
            if event.name == "s":
                (screen, rotation) = move_object(screen, Movement.DOWN, rotation)
            elif event.name == "d":
                (screen, rotation) = move_object(screen, Movement.RIGHT, rotation)
            elif event.name == "a":
                (screen, rotation) = move_object(screen, Movement.LEFT, rotation)
            elif event.name == "space":
                (screen, rotation) = move_object(screen, Movement.ROTATE, rotation)

def move_object(screen: list, movement: Movement, rotation: int) -> (list,int):
